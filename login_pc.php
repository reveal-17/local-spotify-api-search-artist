        ...
        <div id="app">
            <div class="songsSearch">
                ...
                <div class="songsSearch__login">
                    ...
                    <!-- submit -->
                    <el-form-item class="songsSearch__loginSubmit">
                        <el-button name="signup_submit" native-type="submit" type="primary" @click="submitForm('ruleForm'); submitForm('dynamicValidateForm');">ログイン</el-button>
                    </el-form-item>
                    </el-form>
                </div>
